...
public class OpenGlActivity  extends Activity {
    ...
    public static class GlView implements GLSurfaceView.Renderer {
        ...
        public GlView(Context context)
        {
            ...
            loader.load(R.raw.finalbasemesh);
            verts = loader.vtx;
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            Matrix.translateM(modMat, 0, 2.0f, -15.0f, -3.0f);
            Matrix.rotateM(modMat, 0, 0, 0.0f, 1.0f, 0.0f);
